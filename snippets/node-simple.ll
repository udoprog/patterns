...
@alloc1 = private unnamed_addr constant <{ [23 x i8] }> <{ [23 x i8] c"snippets/node-simple.rs" }>, align 1
@alloc2 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [23 x i8] }>, <{ [23 x i8] }>* @alloc1, i32 0, i32 0, i32 0), [16 x i8] c"\17\00\00\00\00\00\00\00\0F\00\00\00\22\00\00\00" }>, align 8
...
start:
  ...
  %7 = load {}*, {}** %6, align 8
  %8 = icmp eq {}* %7, null
  br i1 %8, label %bb1.i, label %"_ZN4core6option15Option$LT$T$GT$6unwrap17h1071e9a7ce7619acE.exit"

bb1.i:                                            ; preds = %start
; call core::panicking::panic
  tail call void @_ZN4core9panicking5panic17hedbcaa5a849f0fe8E([0 x i8]* noalias nonnull readonly align 1 bitcast (<{ [43 x i8] }>* @alloc0 to [0 x i8]*), i64 43, %"std::panic::Location"* noalias readonly align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc2 to %"std::panic::Location"*))
  unreachable

"_ZN4core6option15Option$LT$T$GT$6unwrap17h1071e9a7ce7619acE.exit": ; preds = %start
  %9 = bitcast {}* %7 to %Node*
  %10 = getelementptr inbounds %Node, %Node* %9, i64 0, i32 5
