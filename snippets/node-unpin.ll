...
@alloc2 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [22 x i8] }>, <{ [22 x i8] }>* @alloc1, i32 0, i32 0, i32 0), [16 x i8] c"\16\00\00\00\00\00\00\00\12\00\00\00\19\00\00\00" }>, align 8
...
start:
  ...
  %4 = load {}*, {}** %3, align 8
  %5 = icmp eq {}* %4, null
  br i1 %5, label %bb1.i, label %"_ZN4core6option15Option$LT$T$GT$6unwrap17h07920c5c9adb30f3E.exit"
...
"_ZN4core6option15Option$LT$T$GT$6unwrap17h07920c5c9adb30f3E.exit": ; preds = %start
  %6 = bitcast {}* %4 to %Node*
  %7 = getelementptr inbounds %Node, %Node* %6, i64 0, i32 7
